#include "PhoenixLexer.h"

namespace PhoenixLib
{
	PhoenixLexer::PhoenixLexer()
	{
	}
	
	void PhoenixLexer::AddToken(std::string name, char* pattern)
	{
		st_PrivateToken tok;
		tok.name = name;
	...
	std::vector<PhoenixLib::PhoenixLexer::st_Token> PhoenixLexer::TokenizeString(std::string str)
	{
